...
Connection* Structure::connect_layers_expected(
    ...
    layer_config.rows =
        get_expected_rows(from_layer->rows, conn_config.type, conn_config.connection_params);
    layer_config.columns =
        get_expected_columns(from_layer->columns, conn_config.type, conn_config.connection_params);

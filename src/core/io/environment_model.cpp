...
void EnvironmentModel::add_module(ModuleConfig* config) {
...
void EnvironmentModel::remove_modules() {
...
void EnvironmentModel::remove_modules(std::string structure,
        std::string layer) {
...
IOTypeMask EnvironmentModel::get_type(std::string structure, std::string layer)
